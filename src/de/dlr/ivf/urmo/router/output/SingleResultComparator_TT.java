 ...
 */
public class SingleResultComparator_TT implements Comparator<SingleODResult> {
	/**
	...
	public int compare(SingleODResult c1, SingleODResult c2) {
		...
		if(c1.origin.em.getOuterID()<c2.origin.em.getOuterID()) {
			return -1;
		} else if(c1.origin.em.getOuterID()>c2.origin.em.getOuterID()) {
			return 1;
		}
